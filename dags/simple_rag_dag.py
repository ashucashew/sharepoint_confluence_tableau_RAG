"""
Simple RAG DAG for testing and learning
...
dag = DAG(
    ...
    description='Simple RAG pipeline for learning Airflow',
...
# This creates the flow: health_check → get_status → trigger_sync → print_completion
